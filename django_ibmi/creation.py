...
class DatabaseCreation (BaseDatabaseCreation):
    ...
    data_types = {
        # DB2 Specific
        'AutoField':                    'INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1, CACHE 10 ORDER)',
        # DB2 Specific
        'BigAutoField':                 'BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1, CACHE 10 ORDER)',
        ...
        if autoclobber or confirm == 'yes':
            try:
                ...
                if (message.find('Not supported:') != -1):
                    if not autoclobber:
                        confirm = input("Not able to create test database, %s. Type yes to use %s as test database, or no to exit" % (
